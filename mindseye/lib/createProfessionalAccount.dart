...
class _CreateProfessionalAccountState extends State<CreateProfessionalAccount>
  ...
  void _generateProfessionalID() {
    // UUID v4 (first 4 hex chars), e.g., PROF-AB12
    final uuid = const Uuid().v4(); // e.g., "1b2c3d4e-...."
    _professionalId = "PROF-${uuid.substring(0, 4).toUpperCase()}";
  }
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      _showErrorDialog("Network error. Please try again later.");
    } finally {
      setState(() => _isLoading = false);
    }
  }
  ...
  void _showIdInfo() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: const Text('Professional ID'),
        content: const Text(
          "This ID is auto-generated for uniqueness and cannot be edited.",
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration("Clinic Name *").copyWith(
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration("Work Email *").copyWith(
                    ...
                    TextFormField(
                      ...
                      maxLines: 2,
                      textCapitalization: TextCapitalization.words,
                      decoration: _inputDecoration("Work Address *").copyWith(
                    ...
                    // Professional ID (readOnly so suffixIcon stays tappable)
                    TextFormField(
                      readOnly: true,
                      initialValue: _professionalId,
                      decoration: _inputDecoration("Professional ID").copyWith(
                        prefixIcon: const Icon(Icons.engineering),
                        suffixIcon: Tooltip(
                          message: "Auto-generated. This cannot be changed.",
                          child: IconButton(
                            icon: const Icon(Icons.info_outline),
                            onPressed: _showIdInfo,
                          ),
                        ),
                      ),
                    ),
