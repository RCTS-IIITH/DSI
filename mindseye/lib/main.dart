...
import 'package:mindseye/organizationAdminDashboard.dart';
import 'adminDahboard.dart';
// Import LoginScreen from login.dart
        ...
        return MaterialApp(
          ...
          routes: {
            ...
            'parentDashboard': (context) => ParentDashboardScreen(
                  '', // clinicName positional parameter
                  data: '',
            ...
            'adminDashboard': (context) => AdminDashboard(
                  '', // Positional argument for clinicName
                  data: '',
                ),
            ...
            'organizationAdminDashboard': (context) => OrganizationAdminDashboard(
                  data: '',
                ),
          },
