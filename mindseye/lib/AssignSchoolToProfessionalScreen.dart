...
class _AssignSchoolToProfessionalScreenState
  ...
  Future<void> _fetchInitialData() async {
    ...
    final schoolUri = Uri.parse('$backendUrl/api/users/get-schools')
        .replace(queryParameters: (selectedOrgId != null && selectedOrgId.isNotEmpty)
    ...
    try {
      ...
      if (professionalRes.statusCode == 200 && schoolRes.statusCode == 200) {
        ...
        final schoolData = jsonDecode(schoolRes.body);
        final List<dynamic> schoolList = schoolData['success'] == true 
            ? schoolData['data'] 
            : schoolData;
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                readOnly: true,
                maxLines: 2,
                decoration: _inputDecoration("Assigned Schools").copyWith(
                  filled: true,
                  fillColor: Colors.grey[300],
                  prefixIcon: Icon(Icons.lock, size: 18, color: Colors.grey),
                ),
